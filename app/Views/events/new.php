        ...
        <form method="POST" action="<?php echo base_url(); ?>/savenewevent" enctype="multipart/form-data" style="margin-top:30px;">
          <div class="form-group" style="display:none;">
            <div class="form-line">
              ...
              <select class="form-control" name="branch" requiredautofocus="">
          ...
          <div class="form-group">
            ...
            <div class="form-line">
              <input type="time" class="form-control" name="time" placeholder="Event Date">
            </div>
          </div>

          <div class="form-group">
            <div class="form-line">
              <input type="text" class="form-control" name="title" placeholder="Event Title" autofocus="">
            </div>
          </div>
