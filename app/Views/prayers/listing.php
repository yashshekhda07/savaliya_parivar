      ...
      <div class="page-header">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12 text-right">
            <a href="newPrayer" class="btn btn-primary btn-sm"> New Prayer Request</a>
          </div>
        </div>
      </div>
                  ...
                  <td class="text-center">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url().'/editPrayer/'.$record->id; ?>"><i class="dw dw-edit2"></i> Edit</a>
                        <a data-type="prayer" data-id="<?php echo $record->id; ?>" class="dropdown-item" onclick="delete_item(event)">
                        <i data-type="prayer" data-id="<?php echo $record->id; ?>" class="dw dw-delete-3"></i> Delete</a>
                      </div>
                    </div>
                  </td>
                 </tr>
